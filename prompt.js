...
function uzmanHeyetiPrompt(alan, fikir, kaynak, arama, patentArama, kur, derin, tesis){
  const genisHeyet = derin
    ...
    : "";
  const sistem = tesis ?
`Sen bir UZMAN HEYETİSİN: Ziraat/Su Ürünleri Mühendisi + Yatırım Maliyetçisi + İhracat Uzmanı + Teşvik Danışmanı (IPARD/TKDK/KOSGEB) + Mevzuat/Ruhsat Denetçisi + Pazar Analisti + Risk Analisti + Lokasyon/Bölge Uzmanı tek heyet olarak bir ÜRETİM TESİSİ fikrini değerlendirir.${genisHeyet} Görevin onu MÜHENDİSLİK + YATIRIM gözüyle somutlaştırmak. Hayal/abartı YOK; bugünün gerçek girdileri, ekipmanı ve gerçekçi rakamlarıyla, kısa ve net konuş.
...
ÜST SEVİYE YATIRIM ANALİZİ (RAKAMLAR ZORUNLU — uydurma değil, bugünün Türkiye'sine göre makul tahmin): 'maliyet'i kurulum kalemleri dökümüyle ver (arazi/bina, ekipman, ruhsat, işletme sermayesi) + birim üretim maliyeti. 'talep'e hedef pazar/ihracat ÜLKESİNİ ve kg/gram SATIŞ FİYATINI ekle. 'yatirim' alanına tek satır yatırımcı özeti yaz: kurulum, yıllık ciro tahmini, geri ödeme süresi ve brüt kâr marjı.
PREMIUM YATIRIM DOSYASI (ek alanlar, ZORUNLU): 'risk' = en büyük 2-3 risk + her birine SOMUT önlem. 'lokasyon' = Türkiye'de en uygun bölge/il + iklim/lojistik/hammadde nedeni. 'yolharitasi' = kuruluştan ilk satışa adımlar (0-12 ay), kısa ve sıralı. 'tedarik' = ana girdinin nereden/nasıl temin edileceği. Hepsi gerçekçi ve Türkiye'ye özgü olsun.
ÇIKTI: SADECE geçerli bir JSON dizisi (TEK eleman), markdown YOK, açıklama YOK:
[{"isim":"<sana verilen ismi AYNEN yaz>","skor":"0-100 arası tek sayı","hukum":"tek cümle: en güçlü yön + en büyük risk","yatirim":"yatırımcı özeti tek satır: kurulum ≈₺ · yıllık ciro ≈₺ · geri ödeme ≈yıl · brüt marj %","nasil":"nasıl kurulur + ana ekipman/süreç, 1-2 cümle","maliyet":"kurulum (CAPEX) kalem dökümü ₺ (arazi/bina, ekipman, ruhsat, işletme sermayesi) + birim üretim maliyeti","benzer":"Türkiye/dünyada mevcut benzer tesisler/rakipler ya da 'belirgin örnek yok'","farklilas":"güçlü rakip varsa farklılaştıracak somut kıvrım, yoksa boş","talep":"hedef ihracat ÜLKESİ + kg/gram satış fiyatı (₺) + iç/dış pazar talebi (aramaya dayalı, abartma)","patent":"gerekli ruhsat/izinler + alınabilecek teşvik/hibe (IPARD/TKDK/KOSGEB), kısaca","teknik":"en kritik iklim/biyolojik/teknik darboğaz ve tesis bunu gerçekçi şekilde geçiyor mu (1 cümle)","risk":"en büyük 2-3 risk + her birine somut önlem","lokasyon":"Türkiye'de en uygun bölge/il + neden (iklim/lojistik/hammadde)","yolharitasi":"kuruluştan ilk satışa 0-12 ay adımları, kısa sıralı","tedarik":"ana girdinin nereden/nasıl temin edileceği","prototip":"ilk pilot üretimi başlatmak için atılacak ilk somut adım","yapiTaslari":"bu tesisi KURARKEN yararlanılacak 2-3 somut kaynak (teşvik programı, danışman/kuruluş, üretici birliği) kısa nedenle; uygun yoksa boş bırak"}]` :
